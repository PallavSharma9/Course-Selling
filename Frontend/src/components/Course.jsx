...
function CourseCard(props) {
    ...
    return <div style={{display: "flex", marginTop: 50, justifyContent: "cetner",   width: "100%" }}> 
        <Card style={{margin: 10, width: 350, minHeight: 200, borderRadius: 20, marginRight: 10, paddingBottom: 15, zIndex: 2}}>
            <img src={course.imageLink} style={{width: 350, height: 300}}></img>
